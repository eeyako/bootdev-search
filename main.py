        ...
        with ix.searcher() as searcher:
            ...
            if not results:
                if corrected.query != q:
                    ...
                    print(
                        f"Showing results for '{corrected.string}' instead..."
                    )
...
def parse_args():
    ...
    if not any([args.search, args.index, args.indexed_languages]):
        parser.error(
            'either --index, --indexed-languages optional args or a search is required')
...
if __name__ == '__main__':
    ...
    if args.index:
        ...
        if not language_lessons:
            ...
            print(*langs, sep='\n- ')
        scrape_and_index_lessons(
            lang_lessons=language_lessons,
            schema=schema
        )
